<div class="uploads index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('bytes'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($upload['Upload']['bytes']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $upload['Upload']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $upload['Upload']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
